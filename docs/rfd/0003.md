...
license = "MIT"
homepage = "https://github.com/ar4mirez/samuel-go-guide"
...
```yaml
# Reusable: github.com/ar4mirez/samuel-plugin-release/.github/workflows/release.yml
- uses: sigstore/cosign-installer@v3
- name: Sign blob (skill / WASM)
  if: matrix.kind != 'oci'
  run: |
    cosign sign-blob --bundle ${{ matrix.artifact }}.bundle ${{ matrix.artifact }}
- name: Sign image (OCI)
  if: matrix.kind == 'oci'
  run: |
...
identity_pattern = "https://github.com/ar4mirez/samuel-*/.github/workflows/release.yml@refs/heads/main"
```
